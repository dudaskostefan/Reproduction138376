...
public class ML_Input_Entity_Single_sequence_tokenizer implements com.mendix.systemwideinterfaces.core.IEntityProxy
{
	private final com.mendix.systemwideinterfaces.core.IMendixObject mL_Input_Entity_Single_sequence_tokenizerMendixObject;
	 ...
	 */
	public static final java.lang.String entityName = "BERT.ML_Input_Entity_Single_sequence_tokenizer";
	...
	public ML_Input_Entity_Single_sequence_tokenizer(com.mendix.systemwideinterfaces.core.IContext context)
	{
		this(context, com.mendix.core.Core.instantiate(context, entityName));
	}

	protected ML_Input_Entity_Single_sequence_tokenizer(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mL_Input_Entity_Single_sequence_tokenizerMendixObject)
	{
		if (mL_Input_Entity_Single_sequence_tokenizerMendixObject == null) {
			throw new java.lang.IllegalArgumentException("The given object cannot be null.");
		}
		if (!com.mendix.core.Core.isSubClassOf(entityName, mL_Input_Entity_Single_sequence_tokenizerMendixObject.getType())) {
			throw new java.lang.IllegalArgumentException(String.format("The given object is not a %s", entityName));
		}	

		this.mL_Input_Entity_Single_sequence_tokenizerMendixObject = mL_Input_Entity_Single_sequence_tokenizerMendixObject;
	 ...
	 */
	public static bert.proxies.ML_Input_Entity_Single_sequence_tokenizer initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new bert.proxies.ML_Input_Entity_Single_sequence_tokenizer(context, mendixObject);
	}

	public static bert.proxies.ML_Input_Entity_Single_sequence_tokenizer load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return bert.proxies.ML_Input_Entity_Single_sequence_tokenizer.initialize(context, mendixObject);
	}
	...
	{
		return mL_Input_Entity_Single_sequence_tokenizerMendixObject;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final bert.proxies.ML_Input_Entity_Single_sequence_tokenizer that = (bert.proxies.ML_Input_Entity_Single_sequence_tokenizer) obj;
